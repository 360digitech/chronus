<template>
  <div style="padding:20px">
    ...
    <el-form :inline="true" @submit.native.prevent size="medium">
      <el-form-item label="">
        <el-input size="medium" v-model.trim="queryObj.tag" placeholder="请输入内容" clearable style="width:300px"
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="650px">
      <el-form label-position='right' label-width="110px" size="medium">
        <el-form-item label="tag">
          <el-input v-model.trim="currentObject.tag" :disabled="this.EditType==='edit'?true:false" maxlength="64" show-word-limit></el-input>
        </el-form-item>
        <el-form-item label="备注">
          <el-input v-model.trim="currentObject.remark"></el-input>
        </el-form-item>
      </el-form>
