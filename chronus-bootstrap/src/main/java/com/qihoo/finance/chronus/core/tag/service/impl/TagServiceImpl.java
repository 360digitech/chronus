package com.qihoo.finance.chronus.core.tag.service.impl;
...
public class TagServiceImpl implements TagService {
    ...
    @Override
    public void update(TagEntity tagEntity) throws Exception {
        tagDao.update(tagEntity);
    }

    @Override
    public TagEntity selectByTagName(String tagName) {
    ...
    @Override
    public List<TagEntity> selectListByNames(Set<String> allTagNames) {
        return tagDao.selectListByNames(allTagNames);
    }
